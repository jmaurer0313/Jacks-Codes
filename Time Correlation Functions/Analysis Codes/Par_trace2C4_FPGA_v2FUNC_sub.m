...
% Program information
%--------------------------------------------------------------------------
function [totalRunTime,avgFileRunTime,tau1L,tau3L,NfilesToIterate,filesList] = Par_trace2C4_FPGA_v2FUNC_sub(usres,constructName,tau2ArrayUnits_us,subsetOpt,subsetLoc,subsetName) 
...
%--------------------------------------------------------------------------
    ...
    if subsetOpt
    folderOutName = ['4ptTCFs_SLsub' subsetName '_' constructName  filesep() tau2_subFolderName];
    else
    folderOutName = ['4ptTCFs_SL_' constructName  filesep() tau2_subFolderName];
    end
