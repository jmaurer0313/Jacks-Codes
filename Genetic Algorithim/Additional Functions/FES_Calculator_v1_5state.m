...
%                 'k24' 'k42' 'k34' 'k43'} ;
%             For 5 States 
allRateStrings = {'k12' 'k21' 'k13' 'k31' 'k14' 'k41' 'k15' 'k51' 'k23' 'k32' ...
                'k24' 'k42' 'k25' 'k52' 'k34' 'k43' 'k35' 'k53' 'k45' 'k54'} ;
rateLabels=param_strings(1:length(param_strings)-13);
rates=1./tijs; 
kmax=max(max(K)); 
...
invRatesIdxList=[2,6,3,11,4,16,5,21,8,12,9,17,10,22,14,18,15,23,20,24];
fullInvRates=zeros(1,length(invRatesIdxList)); 

FEScurves=zeros(5,length(FESbins));
for i=1:length(A)
