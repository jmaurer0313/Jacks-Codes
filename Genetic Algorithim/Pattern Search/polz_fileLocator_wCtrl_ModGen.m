function [GenAlgFilesLocationPrefix, genAlgDataLocationPrefix, histogram_FilePath, C2_FilePath,C4_FilePath] = polz_fileLocator_wCtrl_ModGen(terminalID, constructName, modelName, programName, protein_str, saltConditions, fileSuffix)
