...
% just for a bad run with bubbles on 10/17 #2 in Tau=7fs for e5e6)
% if f==2
...
% IMPLEMENTATION  OF PHASE SHIFT TO RECENTER DISTRIBUTIONS PRIOR TO TCF
% CALC
%  
% Xquad1= mean(cos(p1r)); 
% Yquad1= mean(sin(p1r)); 
...
% 
% curTrajCh1= [usecHitList_ch1, p1rLin];
%  curTrajCh2= [usecHitList_ch1, p2rLin];

% 
 curTrajCh1= [usecHitList_ch1, p1r];
 curTrajCh2= [usecHitList_ch1, p2r];
...
for r=1:3
    ...
    if r==3
%         AS OF 2/25/2020 this was changed to unwrap to avoid fast
%         switching of the phase btw value of +/- Pi
