...
function [RPmatOut, NRPmatOut, tbx, tby, window2Dfinal,numPhots] = avg2DFPGA_RT_Lapse(intTime, plotOpt, homeFolder,retiming,rephase)
startFolder= pwd;
cd(homeFolder); 
...
for s=1:numFiles
    ...
    [RPmat, NRPmat, tb1, tb2,~,~,times, numPhots] = ind2DFPGA_RT_Lapse(fileFolder, intTime);
