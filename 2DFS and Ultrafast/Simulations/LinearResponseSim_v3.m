...
% lined up perfectly with the horz polarization component - which in
...
symmBkgdDemodX = @(w,tAOM) 2.*cos(phi0).* ...
            ((cos(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ...
            + (cos(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2 ...
            + (cos(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) ;
        
antiBkgdDemodX =  @(w,tAOM) 2.*cos(phi0).* ...
             ((-sin(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2 ...
            + (-sin(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2 ...
            + (-sin(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) ;
        
symmBkgdDemodY = @(w,tAOM) 2.*sin(phi0).* ...
            ((cos(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ...
            + (cos(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2 ...
            + (cos(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) ;
        
antiBkgdDemodY =  @(w,tAOM) 2.*sin(phi0).* ...
             ((-sin(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2 ...
            + (-sin(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2 ...
            + (-sin(((2*pi*(AO1a-AO2a)*tAOM)/2) - pi/4).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) ;
...
symmInfXquad(m)= sum(symmModX(wAxis,Taxis));
antiInfXquad(m)= sum(antiModX(wAxis,Taxis));
symmBkgdXquad(m)= sum(symmBkgdDemodX(wAxis,Taxis));
antiBkgdXquad(m)= sum(antiBkgdDemodX(wAxis,Taxis));

symmInfYquad(m)=sum(symmModY(wAxis,Taxis));
antiInfYquad(m)=sum(antiModY(wAxis,Taxis));
symmBkgdYquad(m)=sum(symmBkgdDemodY(wAxis,Taxis));
antiBkgdYquad(m)=sum(antiBkgdDemodY(wAxis,Taxis));

% without rotation
symmInfXquadNR(m)= sum(symmModXNR(wAxis,Taxis));
antiInfXquadNR(m)= sum(antiModXNR(wAxis,Taxis));
symmBkgdXquadNR(m)= sum(symmBkgdDemodXNR(wAxis,Taxis));
antiBkgdXquadNR(m)= sum(antiBkgdDemodXNR(wAxis,Taxis));

symmInfYquadNR(m)=sum(symmModYNR(wAxis,Taxis));
antiInfYquadNR(m)=sum(antiModYNR(wAxis,Taxis));
