...
symmModX = @(w,t21,phi) 2.*exp(-abs(t21)/TauDephase).*( ...
    (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ).* cos(t21*(w00s-wR)) + ...
    (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2) .* cos(t21*(w01As-wR)) + ...
    (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) .* cos(t21*(w01Bs-wR)) + ...
    (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ).* cos(t21*(w00s-wR)) + ...
    (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2) .* cos(t21*(w01As-wR)) + ...
    (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) .* cos(t21*(w01Bs-wR)) );


symmModY = @(w,t21,phi) 2.*exp(-abs(t21)/TauDephase).*( ...
    (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ).* sin(t21*(w00s-wR)) + ...
    (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2) .* sin(t21*(w01As-wR)) + ...
    (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) .* sin(t21*(w01Bs-wR)) + ...
    (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ).* sin(t21*(w00s-wR)) + ...
    (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2) .* sin(t21*(w01As-wR)) + ...
    (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) .* sin(t21*(w01Bs-wR)) );


antiModX = @(w,t21,phi) 2.*exp(-abs(t21)/TauDephase).*( ...
    (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2) .* cos(t21*(w00a-wR)) + ...
    (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2) .* cos(t21*(w01Aa-wR)) + ...
    (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) .* cos(t21*(w01Ba-wR)) + ...
    (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2) .* cos(t21*(w00a-wR)) + ...
    (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2) .* cos(t21*(w01Aa-wR)) + ...
    (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) .* cos(t21*(w01Ba-wR)) ) ;


antiModY = @(w,t21,phi) 2.*exp(-abs(t21)/TauDephase).*( ...
    (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2) .* sin(t21*(w00a-wR)) + ...
    (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2) .* sin(t21*(w01Aa-wR)) + ...
    (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) .* sin(t21*(w01Ba-wR)) + ...
    (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2) .* sin(t21*(w00a-wR)) + ...
    (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2) .* sin(t21*(w01Aa-wR)) + ...
    (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) .* sin(t21*(w01Ba-wR)) ) ;

%     interference terms WITHOUT polz rotation 
symmModXNR = @(w,t21) 2.*exp(-abs(t21)/TauDephase).*( ...
...
antiModXNR = @(w,t21) 2.*exp(-abs(t21)/TauDephase).*( ...
...
symmModYNR = @(w,t21) 2.*exp(-abs(t21)/TauDephase).*( ...
...
antiModYNR = @(w,t21) 2.*exp(-abs(t21)/TauDephase).*( ...
...
symmBkgdDemodX = @(w,phi) 2.*abs(cos(phi)).* (...
            (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ) + ...
            (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2)  + ...
            (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) + ...
            (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ) + ...
            (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2) + ...
            (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) );
        
antiBkgdDemodX =  @(w,phi) 2.*abs(cos(phi)).*( ...
             (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2)  + ...
             (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2)  + ...
             (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) + ...
             (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2) + ...
             (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2)  + ...
             (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) ) ;
        
symmBkgdDemodY = @(w,phi) 2.*abs(sin(phi)).* (...
            (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ) + ...
            (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2)  + ...
            (0.5*(cos(phi+pi/2).*Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) + ...
            (0.5*(sin(phi+pi/2).*Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ) + ...
...
antiBkgdDemodY =  @(w,phi) 2.*abs(sin(phi)).*( ...
             (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2)  + ...
             (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2)  + ...
             (0.5*(sin(phi).*Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) + ...
             (0.5*(cos(phi).*Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2) + ...
...
symmBkgdDemodYNR = @(w) 2.* ...
            ((Ew(w,wLa,sigmaL).*symm00(w,w00s,C00s,gammaA)).^2 ...
            + (Ew(w,wLa,sigmaL).*symm01a(w,w01As,C01As,gammaA)).^2 ...
            + (Ew(w,wLa,sigmaL).*symm01b(w,w01Bs,C01Bs,gammaA)).^2) ;
        
antiBkgdDemodYNR =  @(w) 2.* ...
             ((Ew(w,wLa,sigmaL).*anti00(w,w00a,C00a,gammaA)).^2 ...
            + (Ew(w,wLa,sigmaL).*anti01a(w,w01Aa,C01Aa,gammaA)).^2 ...
            + (Ew(w,wLa,sigmaL).*anti01b(w,w01Ba,C01Ba,gammaA)).^2) ;
