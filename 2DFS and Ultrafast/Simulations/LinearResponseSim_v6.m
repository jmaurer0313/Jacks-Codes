...
symmModYNR = @(w,t21) (1/2).*exp(-abs(t21)/TauDephase).*( ...
...
antiModYNR = @(w,t21) (1/2).*exp(-abs(t21)/TauDephase).*( ...
...
% figure(16)
% plot(t21Axis*1e15,(symmInfXquad),t21Axis*1e15,(antiInfXquad),...
%     t21Axis*1e15,(symmInfYquad),t21Axis*1e15, (antiInfYquad))
...
hold on
plot([t21Axis(1), t21Axis(end)]*1e15,[0,0],'--')
